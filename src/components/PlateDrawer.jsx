...
import { X, Plus, Minus, Trash2, ShoppingBag, CheckCircle, ArrowRight, Tag } from 'lucide-react';

export default function PlateDrawer({ isOpen, onClose, plate = [], setPlate, onOpenCheckout }) {
  ...
  const applyCoupon = () => {
    if (couponCode.toUpperCase() === 'NONVEG15') {
      setDiscountPercent(15);
      setCouponMsg('15% Promo Discount Applied!');
    } else if (couponCode.toUpperCase() === 'THAKUR50') {
      setDiscountPercent(10);
      setCouponMsg('₹50 Flat Discount Applied!');
    } else {
      setCouponMsg('Invalid coupon code. Try NONVEG15');
    }
  };
      ...
      <div style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              {plate.map((item) => (
                <div key={item.id} style={{
                  ...
                  border: '1px solid rgba(255, 255, 25, 0.06)',
                  borderRadius: '14px',
                  padding: '1rem',
                  display: 'flex',
                  gap: '1rem',
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '6px', fontSize: '0.8rem', color: '#f59e0b', marginBottom: '6px' }}>
                  ...
                  <span>Have a promo code? (Try: NONVEG15)</span>
                </div>
                ...
                {couponMsg && (
                  <div style={{ fontSize: '0.75rem', color: discountPercent > 0 ? '#10b981' : '#ef4444', marginTop: '4px' }}>
                    {couponMsg}
                  </div>
                )}
              </div>
        ...
        {plate.length > 0 && (
          <div style={{
            ...
            {discountAmount > 0 && (
              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.88rem', color: '#10b981', marginBottom: '0.4rem' }}>
